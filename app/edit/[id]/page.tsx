...
export default function EditQuiz() {
  ...
  // New state for time limit, start date, end date
  ...
  useEffect(() => {
    const fetchQuiz = async () => {
      ...
      try {
        ...
        setTimeLimit(data.assignment.timeLimit || '');
  ...
  const addQuestion = () => {
    ...
    setEditableQuiz({ ...editableQuiz, questions: [...editableQuiz.questions, newQuestion] });
  };
  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-4xl">
      ...
      {/* Time limit and date range */}
      <Card className="mb-6">
        <CardHeader>
          <CardTitle className="text-xl">Quiz Settings</CardTitle>
          <CardDescription>Set quiz timing and availability.</CardDescription>
        </CardHeader>
