        ...
        <>
            <div className="min-h-screen bg-gradient-to-b from-blue-50 to-indigo-50 py-12 px-4 sm:px-6 lg:px-8">
                <div className="w-full max-w-screen-lg mx-auto px-4 sm:px-6 md:px-8 pt-10 sm:pt-16 pb-10 sm:pb-16 bg-white flex justify-center items-center">
                    <div className="w-full sm:w-auto sm:grow shrink basis-0 self-stretch py-6 bg-gradient-to-b from-blue-50 to-indigo-50 rounded-3xl border-2 border-[#0cdc09] flex flex-col justify-center items-center gap-14">
                        <div className="w-48 sm:w-64 h-32 sm:h-44 bg-[#b2f8ba] rounded-lg shadow flex flex-col justify-center items-center gap-6">
                            <div className="text-center text-black text-2xl sm:text-3xl font-bold font-['Inter']">Welcome</div>
                            <div className="text-center text-black text-lg sm:text-xl font-medium font-['Inter'] truncate w-full px-2">
